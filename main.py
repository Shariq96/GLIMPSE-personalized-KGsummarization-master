...
def answer_queries_in_log(user, KG, K, query_log, summary_methods, test_size=0.5):
    ...
    for summary_method in summary_methods:
        ...
        t0 = time()
        S = summary_method(user, KG, K, train_log)  # call the object as a function
...
def main():
    ...
    for user in range(args.n_users):
        ...
        print()
        answer_queries_in_log(user,KG, K, query_log, summary_methods, test_size=args.test_size)
