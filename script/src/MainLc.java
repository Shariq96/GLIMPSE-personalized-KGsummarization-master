...
public class MainLc {
    ...
    public static void main (String[] arg) throws IOException, ParseException {
        ...
        Gson gson = new Gson();
        JSONArray jsonArray = (JSONArray) parser.parse(new FileReader("F://script/lcquadtest.json"));
       // JSONArray jsonArrayTrain = (JSONArray) parser.parse(new FileReader("F://script/train-data.json"));
